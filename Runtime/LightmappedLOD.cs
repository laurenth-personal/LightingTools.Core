...
/// <summary>
/// Apply this on a LOD in order to use make it use the lightmap from the LOD 0. The meshes need to have similar lightmap UV layouts for it to work properly.
/// </summary>
[ExecuteInEditMode]
